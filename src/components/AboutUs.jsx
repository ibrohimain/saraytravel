...
const AboutUs = () => {
    return (
        <div className='2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%] 2xl:h-[800px] xl:h-[1520px] lg:h-[1550px] md:h-[1900px] sm:h-[1850px] h-[2580px] aboutus pb-20'>
                        ...
                        <div className='2xl:w-[49%] xl:w-[49%] lg:w-[48%] md:w-[60%] sm:w-[100%] w-[100%] 2xl:h-[500px] xl:h-[500px] lg:h-[500px] md:h-[450px] sm:h-[400px] h-[550px] bg-white rounded-[30px] shadow-2xl flex items-center justify-center'>
                            <div className='w-[90%] h-[80%]'>
                                <div className='w-[100%] h-[55%]'>
                                    <p className='2xl:text-[16px] xl:text-[16px] lg:text-[15px] md:text-[14px] sm:text-[12px] text-[12px] text-black'>2023-yilda Allohning marhamati bilan Umra safariga ziyoratchilarni yuborish dasturi – IQRO TRAVEL dasturini yo‘lga qo‘ydik. Dasturni boshlaganimizdan asosiy maqsad musulmonlarga Umra ziyoratini ado etishda yordam ko'rsatib, Islomning beshinchi rukni bo'lmish amalni bajarishga ko'maklashishdir.</p>
                                    <p className='2xl:text-[16px] xl:text-[16px] lg:text-[15px] md:text-[14px] sm:text-[12px] text-[12px] text-black 2xl:mt-[40px] xl:mt-[38px] lg:mt-[36px] md:mt-[10px] sm:mt-[30px] mt-[30px]'>Allohning marhamati bilan bizning jamoamiz juda ko'p tajriba va bilimlarni to'plab ulgurdi. Umra ziyoratini eng yaxshi sharoitlarda ado etishingiz uchun ushbu tajribalarni qo'llashga tayyormiz.</p>
                                ...
                                <div className='2xl:hidden xl:hidden lg:hidden md:hidden sm:flex flex justify-between  w-[100%] h-[45%] mt-4'>
                                    <div className='2xl:w-[47%] xl:w-[47%] lg:w-[47%] md:w-[100%] sm:w-[47%] w-[47%] 2xl:h-[100%] xl:h-[100%] lg:h-[100%] md:h-[48%] sm:h-[100%] h-[98%] bg-white rounded-[20px] about1'></div>
                                    <div className='2xl:w-[47%] xl:w-[47%] lg:w-[47%] md:w-[100%] sm:w-[47%] w-[47%] 2xl:h-[100%] xl:h-[100%] lg:h-[100%] md:h-[48%] sm:h-[100%] h-[98%] bg-white rounded-[20px] about2 2xl:mt-0 xl:mt-0 lg:mt-0 md:mt-3 sm:mt-0 mt-0'></div>
                                </div>
                            </div>
                        </div>
